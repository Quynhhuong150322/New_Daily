...
const fetchArticles = async (category) => {
    try {
        let url = `https://newsdata.io/api/1/news?country=vi&apikey=pub_35731380e0a51b24cc5e9e0c6dc8e7d1b73b8`;

        if (category === 'Tin mới nhất') {
            url = `https://newsdata.io/api/1/news?country=vi&category=sports&apikey=pub_35731380e0a51b24cc5e9e0c6dc8e7d1b73b8`;
        } else if (category === 'Xu hướng') {
            url = `https://newsdata.io/api/1/news?country=vi&category=top&apikey=pub_35731380e0a51b24cc5e9e0c6dc8e7d1b73b8`;
        }
