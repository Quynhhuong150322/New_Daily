      ...
      <ScrollView>
        <View style={{  }}>
          ...
          <View style = {{
            ...
            <Tab icon="checkmark-circle" title="Chế độ đọc " navigateTo="Home" fontWeight='bold' />
            <Tab icon="bookmark" title="Thông báo" navigateTo="Home" fontWeight='bold'/>
            <Tab icon="checkmark-circle" title="Chế độ nền tối" navigateTo="Home" fontWeight='bold'/>
            <Tab icon="bookmark" title="Quản lý tài khoản " navigateTo="Home" fontWeight='bold'/>
            <Tab icon="checkmark-circle" title="Đăng xuất tài khoản" navigateTo="Home" fontWeight='bold'/>
          </View>
        </View>
      </ScrollView>
    </SafeAreaView>
