...
function LogoTitle() {
    return (
        <Image
            style={{ width: 128, height: 20, marginLeft:0}}
    ...
    return (
        <HomeStack.Navigator>
            <HomeStack.Screen 
                ...
                options={{
                    headerLeft: props => <LogoTitle {...props} />, // Chuyển LogoTitle sang headerLeft
                    headerTitle: props => <Text>Home Screen</Text>, // Đặt tiêu đề tại đây
                    headerRight: () => (
