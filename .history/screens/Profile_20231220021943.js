      ...
      <ScrollView>
        <View style={{  }}>
          ...
          <View style={{
            ...
            <Text style={{
              marginBottom: 10,
              }}>Thuộc lớp Công nghệ lập trình đa nền tảng cho ứng dụng di động - IE307.O13.CNCL</Text>
            <Text style={{
              marginBottom: 10,
              }}>Địa chỉ: Khu phố 6, P.Linh Trung, Tp.Thủ Đức, Tp.Hồ Chí Minh</Text>
            <Text style={{
              marginBottom: 10,
              }}>Email: 20521383@gm.uit.edu.vn hoặc 20521357@gm.uit.edu.vn</Text>
            <Text style={{
              marginBottom: 10,
              }}>© 2023. Toàn bộ bản quyền thuộc về New Daily</Text>
          </View>
