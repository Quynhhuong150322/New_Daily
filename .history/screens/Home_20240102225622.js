...
const CarouselArticle = ({ item1 }) => {
    ...
    return (
        <TouchableOpacity onPress={() => navigateToArticleDetail(item1)} style={styles.carouselItem}>
            <ImageBackground source={{ uri: imageUrl }} style={styles.carouselImage}>
                <View style={styles.carouselHeader} blurRadius={5}>
                    <Text style={styles.carouselCategory}>{item1.category}</Text>
                    <Text style={styles.carouselTitle}>{item1.title}</Text>
                    <View style={styles.carouseFooter}>
                        <Text style={styles.carouselAuthor}>{item1.creator || 'Unknown Author'}</Text>
                        <Text style={styles.carouselDate}>{new Date(item1.pubDate).toLocaleDateString()}</Text>
                    </View>
                </View>
            </ImageBackground>
        </TouchableOpacity>
