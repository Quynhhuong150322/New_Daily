            ...
            <View style={{ flex: 1, marginHorizontal: 22 }}>
                ...
                {/* <View style={{ marginBottom: 12 }}>
                    ...
                    <View style={{
                        ...
                        <TextInput
                            placeholder='+91'
                            placeholderTextColor={colors.Den}
                            keyboardType='numeric'
                            style={{
                                width: "12%",
                                borderRightWidth: 1,
                                borderLeftColor: colors.Xam1,
                                height: "100%"
                            }}
                        />
                ...
                <View style={{
                    ...
                    <Text style={{ color: colors.Xanh_dam }}>Điều khoản</Text>
                    <Text> và </Text>
                    <Text style={{ color: colors.Xanh_dam }}>điều kiện</Text>
                </View>
                ...
                <View style={{
                    ...
                    <Text style={{ fontSize: 16, color: colors.Xanh_dam }}>Already have an account</Text>
                    <Pressable
